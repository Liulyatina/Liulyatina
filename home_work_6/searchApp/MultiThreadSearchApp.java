...
public class MultiThreadSearchApp {
    ...
    private static void processFiles(List<File> textFiles, Map<String, Integer> resultMap,
        ...
        for (File file : textFiles) {
            Callable<Void> task = () -> {
                ...
                System.out.println(file.getName() + " - " + searchWord + " - " + wordCount);
                return null;
            };
    ...
    private static void writeResultsToFile(Map<String, Integer> resultMap) {
